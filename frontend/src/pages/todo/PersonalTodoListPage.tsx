...
const PersonalTodoListPage = () => {
  ...
  const todoQuery = usePersonalTodoList(page, completed);
  ...
  return (
    <section className="todo-page">
      ...
      <div className="todo-progress-card">
        <div>
          <span className="todo-progress-label">내 진행률</span>
      ...
      {!todoQuery.isLoading && !todoQuery.isError && todos.length === 0 && (
        <div className="empty-state">아직 등록된 개인 할일이 없습니다.</div>
      )}
